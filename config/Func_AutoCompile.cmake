...
set( INSTALL_EXTLIB      "${AutoCompile_INSTALLEXT_LIB}" )
set( INSTALL_EXTINC      "${AutoCompile_INSTALLEXT_INC}" )
set( INSTALL_EXTFLAG     "${AutoCompile_INSTALLEXT_FLAG}" )
...
if (NOT "${INSTALL_EXT_INC}" STREQUAL "" )
    ...
    target_link_libraries(${INSTALL_NAME} ${INSTALL_EXTINC} )
endif()

if (NOT "${INSTALL_EXT_FLAG}" STREQUAL "" )
    message("${Green}  - INSTALL_EXT_FLAG  : ${White}${INSTALL_EXT_FLAG}")
    target_link_libraries(${INSTALL_NAME} ${INSTALL_EXTFLAG} )
endif()
